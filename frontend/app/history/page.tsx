      ...
      <header className="bg-gradient-to-r from-slate-900 to-slate-800 px-6 py-12 sm:py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="text-slate-400 text-sm sm:text-base ml-12">
            Semua rencana perjalanan yang pernah kamu buat dengan KelanaAI.
          </p>
        </div>
      </header>
          ...
          {status === "error" && (
            <div className="flex flex-col items-center justify-center py-24 text-center">
              ...
              <p className="text-sm text-slate-500 mt-1 mb-6">
                Pastikan backend sedang berjalan di <code className="bg-slate-100 px-1.5 py-0.5 rounded text-xs">localhost:8000</code>
              </p>
              <button
