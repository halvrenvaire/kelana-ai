        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-2">
              <span className="material-symbols-outlined text-[#00668a] text-4xl" style={{ fontVariationSettings: "'FILL' 1" }}>
                luggage
              </span>
              <h1 className="text-4xl font-black text-[#0f1419]">Create New Trip</h1>
            </div>
            <p className="text-lg text-[#64748b]">
              Plan your perfect journey with AI-powered itinerary generator 🌍
            </p>
          </div>
            ...
            <div>
              {isLoading ? (
                <div className="glass-card rounded-2xl p-8 flex flex-col items-center justify-center min-h-[400px]">
                  ...
                  <p className="text-sm font-semibold text-[#45464d]">Generating your perfect itinerary...</p>
                  <p className="text-xs text-[#76777d] mt-1">This might take a few seconds</p>
                </div>
              ) : tripData ? (
                ...
                <div className="glass-card rounded-2xl p-8 flex flex-col items-center justify-center min-h-[400px] border-2 border-dashed border-[#e0e3e5]">
                  <span className="material-symbols-outlined text-[#c6c6cd] text-6xl mb-4" style={{ fontVariationSettings: "'FILL' 1" }}>
                    flight_takeoff
                  </span>
